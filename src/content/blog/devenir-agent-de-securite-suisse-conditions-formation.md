---
title: "Devenir agent de sécurité en Suisse : conditions, formation et carrière"
date: 2026-04-15
description: "Comment devenir agent de sécurité en Suisse romande ? Conditions d'accréditation, casier, formation concordataire, brevet fédéral et spécialisations : le guide complet pour se lancer."
image: "/assets/blog/devenir-agent-cover.jpg"
category: Sécurité
...
<div style="margin:2rem 0;padding:1.25rem 1.5rem;background:#f1f5f9;border-radius:12px;">
  <p style="margin:0;color:#475569;line-height:1.6;font-size:.95rem;">Cet article suppose que vous connaissez déjà les bases du métier. Si ce n'est pas le cas, commencez par : <a href="/blog/agent-de-securite-suisse-formation">Agent de sécurité en Suisse : un vrai métier, une vraie formation</a>.</p>
</div>
...
C'est un examen professionnel fédéral, organisé par l'association faîtière de la branche, l'[Association des entreprises suisses de services de sécurité (AESS / VSSU)](https://vssu.org/fr/examens-professionnels/), sous l'égide de la Confédération. Pour s'y présenter, il faut déjà de l'expérience dans le domaine, une qualification de base, avoir 22 ans révolus et un casier judiciaire vierge.
...
<div style="margin:2.25rem 0 1.25rem;padding:1.25rem 1.5rem;background:#f1f5f9;border-radius:12px;">
  <p style="margin:0;color:#475569;line-height:1.6;font-size:.95rem;">📎 <strong>Pour aller plus loin.</strong> Côté client cette fois : <a href="/blog/choisir-entreprise-de-securite-suisse">comment reconnaître une entreprise de sécurité sérieuse</a>.</p>
</div>
...
<div style="margin:2.75rem 0 1rem;padding:1.75rem;background:#0a1929;border-radius:16px;display:flex;flex-wrap:wrap;align-items:center;gap:1.75rem;">
  <div style="flex:1 1 260px;min-width:240px;">
    <p style="margin:0 0 .4rem;font-size:.78rem;font-weight:700;letter-spacing:.06em;text-transform:uppercase;color:#6B93E8;">Le réseau Edgward</p>
    <h3 style="margin:0 0 .65rem;font-size:1.4rem;line-height:1.25;color:#ffffff;">Agent ou entreprise de sécurité ? Rejoignez le réseau</h3>
    <p style="margin:0 0 1.25rem;color:#cbd5e1;line-height:1.55;">Edgward met en relation les particuliers et les entreprises avec des agents partenaires formés et autorisés. Vous exercez dans la sécurité ? Découvrez comment devenir partenaire.</p>
    <a href="/partenaires" style="display:inline-block;background:#4678DC;color:#ffffff;text-decoration:none;font-weight:600;padding:.75rem 1.5rem;border-radius:10px;">Devenir partenaire</a>
  </div>
</div>
