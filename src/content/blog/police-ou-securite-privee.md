---
title: "« Si j'ai un problème, j'appelle la police » : ce que ce réflexe oublie"
date: 2026-05-17
description: "Appeler la police est le bon réflexe en cas d'urgence. Mais pour un doute, un rôdeur ou une vérification, elle n'est pas toujours la bonne réponse. Voici pourquoi police et sécurité privée ne jouent pas le même rôle."
image: "/assets/blog/police-ou-edgward.jpg"
category: Sécurité
...
<figure>
  <a href="https://www.youtube.com/shorts/Imvg4bb_v40" target="_blank" rel="noopener" style="position:relative;display:block;max-width:340px;margin-inline:auto;border-radius:12px;overflow:hidden;">
    <img src="/assets/blog/police-video-thumb.jpg" alt="Vidéo Edgward : si j'ai un souci, j'appelle la police ?">
    <span aria-hidden="true" style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;">
      <span style="display:flex;align-items:center;justify-content:center;width:64px;height:64px;border-radius:50%;background:rgba(70,120,220,0.92);box-shadow:0 4px 16px rgba(0,0,0,0.35);">
  ...
  <figcaption>« Si j'ai un souci, j'appelle la police ! » - on vous explique en une minute pourquoi ce n'est pas toujours la bonne réponse.</figcaption>
</figure>
...
<div style="margin:2.75rem 0 1rem;padding:1.75rem;background:#0a1929;border-radius:16px;display:flex;flex-wrap:wrap;align-items:center;gap:1.75rem;">
  <div style="flex:1 1 260px;min-width:240px;">
    ...
    <h3 style="margin:0 0 .65rem;font-size:1.4rem;line-height:1.25;color:#ffffff;">Agissez sur vos priorités, sans attendre dans la file</h3>
    <p style="margin:0 0 1.25rem;color:#cbd5e1;line-height:1.55;">Un doute, un rôdeur, une absence ? Commandez une intervention depuis votre téléphone. Un agent partenaire se déplace, vous suivez son arrivée et vous recevez un rapport. Sur Genève, en 10 à 15 minutes en moyenne.</p>
