---
title: "Emménager : les 7 choses à faire la première semaine"
date: 2026-08-31
description: "Nouveau logement, cartons partout, et une question qu'on repousse toujours : qui possède encore une clé de chez vous ? Les 7 gestes de sécurité à régler dans les premiers jours, en Suisse romande."
...
guideDesc: "Les 7 points de cet article sur une page à imprimer, avec des cases à cocher. À garder sur un carton le temps de tout déballer."
guidePromo: 'Pour votre emménagement : <strong>20% sur l''abonnement annuel</strong> avec le code <code>NEWHOME</code>, soit CHF 120 au lieu de 150 la première année. Et dans tous les cas, les <a href="/alertes">alertes et informations de sécurité</a> autour de votre adresse restent gratuites, avec ou sans abonnement.'
---
...
Voici les sept choses à régler pendant cette fenêtre, dans l'ordre où elles comptent. Et pour cocher au fur et à mesure plutôt que de tout retenir, nous en avons fait une [check-list d'une page à imprimer](#checklist), à télécharger gratuitement.
...
C'est ce dernier cas qui laisse le plus souvent démuni, et nous l'avons détaillé dans notre article [« Si j'ai un problème, j'appelle la police » : ce que ce réflexe oublie](/blog/police-ou-securite-privee).

## Et après la première semaine ?

Une fois ces sept points réglés, l'essentiel est fait. Le reste peut se construire tranquillement : un éclairage extérieur à détection, une ou deux caméras bien placées, des prises programmables qui simulent une présence pendant les absences. Nous avons détaillé le choix du matériel dans notre [guide pour choisir sa caméra de surveillance](/blog/comment-choisir-sa-camera-de-surveillance) et les bons emplacements dans le [guide d'installation](/blog/installer-ses-cameras-de-surveillance-soi-meme).
